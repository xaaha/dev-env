...
M.highlights = {
  ...
  -- Keywords
  ["@keyword"] = { fg = campfire.amber, italic = true },
  ["@keyword.function"] = { fg = campfire.amber, italic = true },
  ["@keyword.return"] = { fg = campfire.amber, italic = true },
  ["@keyword.operator"] = { fg = campfire.amber, italic = true },
  ["@keyword.coroutine"] = { fg = campfire.amber, italic = true },
  Keyword = { fg = campfire.amber, italic = true },
  Statement = { fg = campfire.amber, italic = true },
  Conditional = { fg = campfire.amber, italic = true },
  Repeat = { fg = campfire.amber, italic = true },
  -- Types
