...
M.highlights = {
  ...
  -- Keywords
  ["@keyword"] = { fg = campfire.amber },
  ["@keyword.function"] = { fg = campfire.amber },
  ["@keyword.return"] = { fg = campfire.amber },
  ["@keyword.operator"] = { fg = campfire.amber },
  ["@keyword.coroutine"] = { fg = campfire.amber },
  Keyword = { fg = campfire.amber },
  Statement = { fg = campfire.amber },
  Conditional = { fg = campfire.amber },
  Repeat = { fg = campfire.amber },
  -- Types
